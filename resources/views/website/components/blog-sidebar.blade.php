        ...
        <div class="widget widget-categories-list">
            ...
            <div class="widget-content">
                <ul class="category-list">
                    <li>
                        <a href="blog-details.html"><span class="categories-name">Eye Care</span> <span
                                class="categories-count">(18)</span></a>
                    </li>
                    <li>
                        <a href="blog-details.html"><span class="categories-name">Glasses</span> <span
                                class="categories-count">(22)</span></a>
                    </li>
                    <li>
                        <a href="blog-details.html"><span class="categories-name">Eye treatment</span> <span
                                class="categories-count">(10)</span></a>
                    </li>
                    <li>
                        <a href="blog-details.html"><span class="categories-name">Glaucoma</span> <span
                                class="categories-count">(15)</span></a>
                    </li>
                    <li>
                        <a href="blog-details.html"><span class="categories-name">Ophthalmology</span> <span
        ...
        <div class="widget widget-recent-post">
            ...
            <div class="widget-content">
                <div class="recent-post-item d-flex">
                    <div class="recent-post-image flex-shrink-0">
                        <figure class="image-anime">
                            <img src="assets/images/widgets/recent-post/recent-post-1.jpg" alt="recent post one">
                        </figure>
                    </div>
                    <div class="recent-post-content flex-grow-1 ms-3">
                        <h4><a href="blog-details.html">Signs or risk factors for eye disease</a></h4>
                        <p class="post-date">
                ...
                <div class="recent-post-item d-flex">
                    <div class="recent-post-image flex-shrink-0">
                        <figure class="image-anime">
                            <img src="assets/images/widgets/recent-post/recent-post-2.jpg" alt="recent post two">
                        </figure>
                    </div>
                    <div class="recent-post-content flex-grow-1 ms-3">
                        <h4><a href="blog-details.html">What Can You Do To Reduce Dry Eyes</a></h4>
                        <p class="post-date">
                            <i class="fa-solid fa-calendar-days"></i>
                            March 15, 2025
                        </p>
                ...
                <div class="recent-post-item d-flex">
                    <div class="recent-post-image flex-shrink-0">
                        <figure class="image-anime">
                            <img src="assets/images/widgets/recent-post/recent-post-3.jpg" alt="recent post three">
                        </figure>
                    </div>
                    <div class="recent-post-content flex-grow-1 ms-3">
                        <h4><a href="blog-details.html">Protect Your Eyes From Dust And Disease</a></h4>
                        <p class="post-date">
                            <i class="fa-solid fa-calendar-days"></i>
                            March 18, 2025
                        </p>
