                                    ...
                                    <div class="dropdown ms-auto">
                                        ...
                                        <ul class="dropdown-menu dropdown-menu-end">
                                            <li class="dropdown-item"><a href="javascript:void(0);"><i
                                                        class="fa fa-user-circle text-primary me-2"></i>View profile</a>
                                            </li>
                                            <li class="dropdown-item"><a href="javascript:void(0);"><i
                                                        class="fa fa-users text-primary me-2"></i>Add to close friends</a>
                                            </li>
                                            <li class="dropdown-item"><a href="javascript:void(0);"><i
                            ...
                            <div class="card">
                                <div class="card-body">
                                    <div class="profile-blog">
                                        ...
                                        <img src="images/profile/1.jpg" alt="" class="img-fluid rounded mt-4 mb-4 w-100">
                                ...
                                <div class="card-body">
                                    <div class="profile-interest">
                                        ...
                                        <div class="row mt-4 sp4" id="lightgallery">
                                            <a href="images/profile/2.jpg" data-src="images/profile/2.jpg"
                                                class=" lg-item mb-1 col-lg-4 col-xl-4 col-sm-4 col-6">
                                                <img src="images/profile/2.jpg" alt="" class="img-fluid rounded">
                                            </a>
                                            <a href="images/profile/3.jpg" data-src="images/profile/3.jpg"
                                                class=" lg-item mb-1 col-lg-4 col-xl-4 col-sm-4 col-6">
                                                <img src="images/profile/3.jpg" alt="" class="img-fluid rounded">
                                            </a>
                                            <a href="images/profile/4.jpg" data-src="images/profile/4.jpg"
                                                class=" lg-item mb-1 col-lg-4 col-xl-4 col-sm-4 col-6">
                                    ...
                                    <div class="profile-news">
                                        ...
                                        <div class="media pt-3 pb-3">
                                            ...
                                            <div class="media-body">
                                                <h5 class="m-b-5"><a href="post-details.html" class="text-black">Gene
                                                        Therapy Triumph: Curing Incurable Diseases!</a></h5>
                                                <p class="mb-0">I shared this on my twitter wall a few months back, and I
                                                    thought.</p>
                                            </div>
                                        </div>
                                        <div class="media pt-3 pb-3">
                                            ...
                                            <div class="media-body">
                                                <h5 class="m-b-5"><a href="post-details.html" class="text-black">Hospital
                                                        Outreach Program Boosts Community Health</a></h5>
                                        ...
                                        <div class="media pt-3 pb-3">
                                            ...
                                            <div class="media-body">
                                                <h5 class="m-b-5"><a href="post-details.html" class="text-black">AI
                                                        Diagnosis: A Game-Changer in Patient Care</a></h5>
                                                <p class="mb-0">I shared this on my insta wall a few week back, and I
                                                    thought.</p>
                                            </div>
                                        </div>
                                    </div>
                                            ...
                                            <div class="my-post-content pt-3">
                                                            ...
                                                            <div class="modal-content">
                                                                ...
                                                                <div class="modal-body">
                                                                    <div class="input-group mb-3 flex-nowrap">
                                                                        <span
                                                                            class="input-group-text rounded-sm">Upload</span>
                                                ...
                                                <div class="profile-uoloaded-post border-bottom-1 pb-5">
                                                    ...
                                                    <a class="post-title" href="post-details.html">
                                                        <h3 class="text-black">Gene Therapy Triumph: Curing Incurable
                                                            Diseases!</h3>
                                                    </a>
                                                ...
                                                <div class="profile-uoloaded-post border-bottom-1 pb-5">
                                                    ...
                                                    <a class="post-title" href="post-details.html">
                                                        <h3 class="text-black">Medical Advancement: Cutting-Edge Robotic
                                                            Surgeries Revolutionize Treatment</h3>
                                                    </a>
                                                    <p>Lorem Ipsum is simply dummy text of the printing and typesetting
                                                        industry. Lorem Ipsum has been the industry's standard dummy text
                                                        ever since the 1500s, when an unknown printer took a galley of type
                                                ...
                                                <div class="profile-uoloaded-post pb-3">
                                                    <img src="images/profile/8.jpg" alt="" class="img-fluid w-100 rounded">
                                                    <a class="post-title" href="post-details.html">
                                                        <h3 class="text-black">Breaking Barriers: Hospital's Innovative
                                                            Research Marks a Turning Point in Healthcare</h3>
                                                    </a>
                                                    <p>Lorem Ipsum is simply dummy text of the printing and typesetting
                                                        industry. Lorem Ipsum has been the industry's standard dummy text
                                                        ever since the 1500s, when an unknown printer took a galley of type
