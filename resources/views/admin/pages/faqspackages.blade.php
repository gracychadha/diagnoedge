                        ...
                        <tbody>
                            @forelse($faqs as $faq)
                                <tr>
                                    ...
                                    <td>
                                        <span class="badge light badge-{{ $faq->status == 'active' ? 'success' : 'danger' }}">
                                            {{ ucfirst($faq->status) }}
                                        </span>
                                    </td>
                                    <td class="text-center">
                                        <button class="btn btn-sm btn-info light" data-bs-toggle="modal" data-bs-target="#view{{ $faq->id }}">
                                            <i class="fas fa-eye"></i>
                                        </button>
                                        <button class="btn btn-sm btn-warning light" data-bs-toggle="modal" data-bs-target="#edit{{ $faq->id }}">
                                            <i class="fas fa-edit"></i>
                                        </button>
                                        <form action="{{ route('faqspackages.destroy', $faq) }}" method="POST" class="d-inline">
                                            @csrf @method('DELETE')
                        ...
                        <div class="row g-3">
                            ...
                            <div class="col-md-6">
                                ...
                                <select name="link_type" class="form-control link-type" required>
                                    ...
                                    <option value="package" {{ $faq->subparameter_id ? 'selected' : '' }}>Health Package</option>
                                </select>
                            </div>
                            <div class="col-md-6 parameter-group" style="{{ $faq->parameter_id ? 'display:block;' : 'display:none;' }}">
                                <label>Select Parameter</label>
                                <select name="parameter_id" class="form-control">
                                    <option value="">-- Choose Parameter --</option>
                                    @foreach($parameters as $p)
                            ...
                            <div class="col-md-6 package-group" style="{{ $faq->subparameter_id ? 'display:block;' : 'display:none;' }}">
                                <label>Select Health Package</label>
                                <select name="subparameter_id" class="form-control">
                                    <option value="">-- Choose Package --</option>
                                    @foreach($packages as $pkg)
