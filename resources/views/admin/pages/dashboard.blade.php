                                            ...
                                            <svg width="28" height="19" viewbox="0 0 28 19" fill="none"
                                                ...
                                                <defs>
                                                    <lineargradient id="paint0_linear4" x1="13.7187" y1="3.0625"
                                                        ...
                                                        <stop stop-color="white" stop-opacity="0.73" offset="0.1"></stop>
                                ...
                                <ul class="timeline">
                                    <li>
                                        <div class="timeline-panel flex-wrap">
                                            ...
                                            <div class="media-body">
                                                <h5 class="mb-1"><a class="text-black" href="patient-details.html">Aziz
                                                        Bakree</a></h5>
                                    ...
                                    <li>
                                        <div class="timeline-panel flex-wrap">
                                            ...
                                            <div class="media-body">
                                                <h5 class="mb-1"><a class="text-black" href="patient-details.html">Uli
                                                        Trumb</a></h5>
                                                <span class="fs-14">24 Years</span>
                                            </div>
