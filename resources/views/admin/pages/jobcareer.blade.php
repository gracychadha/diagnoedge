                                ...
                                <tbody>
                                    @forelse($jobs as $index => $job)
                                        <tr>
                                            ...
                                            <td>
                                                <span class="badge light badge-{{ $job->is_active ? 'success' : 'danger' }} px-3 py-2">
                ...
                <div class="modal-body">
                    <div class="row g-3">
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="text" name="type" placeholder="Enter Job Type" class="form-control" placeholder="Full Time, Contract, etc." required>
                        </div>
                        <div class="col-md-6">
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="text" name="salary_range" placeholder="Enter salary range" class="form-control" placeholder="e.g. ₹30,000 - ₹50,000">
                        </div>
                        <div class="col-md-6">
                            <label>Experience <span class="text-danger">*</span></label>
                            <input type="text" placeholder="Enter experience needed" name="experience" class="form-control" required>
                        </div>
                        <div class="col-md-6">
                            <label>Qualification <span class="text-danger">*</span></label>
                            <input type="text" placeholder="enter qualification needed" name="qualification" class="form-control" required>
                        </div>
                        <div class="col-12">
                            <label>Description</label>
                            <textarea name="description" placeholder="Enter additional description" class="form-control summernote" rows="5"></textarea>
                        </div>
                        <div class="col-md-6">
                            <div class="form-check mt-3">
                                <input type="checkbox" name="is_featured" value="1" class="form-check-input" id="add_featured">
                                <label class="form-check-label text-danger fw-bold" for="add_featured">Urgent Hiring</label>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form-check mt-3">
    ...
    <div class="modal-dialog modal-xl">
        <form action="{{ route('jobcareer.update', $job) }}" method="POST">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="row g-3">
                        <div class="col-md-6"><input type="text" name="title" value="{{ old('title', $job->title) }}" class="form-control" required></div>
                        <div class="col-md-6"><input type="text" name="type" value="{{ old('type', $job->type) }}" class="form-control" required></div>
                        <div class="col-md-6"><input type="text" name="location" value="{{ old('location', $job->location) }}" class="form-control" required></div>
                        <div class="col-md-6"><input type="text" name="salary_range" value="{{ old('salary_range', $job->salary_range) }}" class="form-control"></div>
                        <div class="col-md-6"><input type="text" name="experience" value="{{ old('experience', $job->experience) }}" class="form-control" required></div>
                        <div class="col-md-6"><input type="text" name="qualification" value="{{ old('qualification', $job->qualification) }}" class="form-control" required></div>
                        <div class="col-12">
                            <textarea name="description" class="summernote">{!! old('description', $job->description) !!}</textarea>
                        </div>
                        <div class="col-md-6">
                            <div class="form-check mt-3">
